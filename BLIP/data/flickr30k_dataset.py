...
class flickr30k_train(Dataset):
    def __init__(self, transform, image_root, ann_root, max_words=30, prompt='', en=False):        
        '''
        ...
        if self.en:
            ...
            filename = 'flickr30k_train_tr.json'
...
class flickr30k_retrieval_eval(Dataset):
    def __init__(self, transform, image_root, ann_root, split, max_words=30, en=False):  
        ...
        if self.en:
            ...
            filenames = {'val':'flickr30k_val_tr.json','test':'flickr30k_test_tr.json'}
