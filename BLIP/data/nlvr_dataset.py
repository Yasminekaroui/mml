...
class nlvr_dataset(Dataset):
    def __init__(self, transform, image_root, ann_root, split, lan):  
        '''
        image_root (string): Root directory of images 
        ann_root (string): directory to store the annotation file
        split (string): train, val or test
        '''
        ###---Download the original nlvr2 annotations if needed-----#####
        ...
        filenames = {'train':f'nlvr_train_{lan}.json','val':f'nlvr_dev_{lan}.json','test':f'nlvr_test_{lan}.json'}
