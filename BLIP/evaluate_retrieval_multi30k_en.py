...
def main(args, config):
    ...
    train_dataset, val_dataset, test_dataset = create_dataset('retrieval_multi30k', config)  
    ...
    for epoch in range(0, config['max_epoch']):    
        ...
        # uncomment this block fo the original code and comment the block added by Yasmine    
        ''' 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/home/karoui/marvl_project/BLIP/configs/retrieval_multi30k_en.yaml')
    parser.add_argument('--output_dir', default='output/MULTI30K/avg_eng') 
